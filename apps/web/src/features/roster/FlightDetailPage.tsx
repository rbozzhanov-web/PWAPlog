...
export function FlightDetailPage() {
  ...
  const flight = useMemo(() => { const roster = loadAimsRoster(); const decoded = key ? decodeURIComponent(key) : ''; return roster?.duties.flatMap((duty) => duty.flights).find((item) => id(item) === decoded); }, [key]);
